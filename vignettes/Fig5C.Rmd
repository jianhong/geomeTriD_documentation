---
title: "Figure 5C Vignette"
author: "Jianhong Ou"
vignette: >
  %\VignetteIndexEntry{Figure 5C Vignette}
...
Figure 5C showcases the geomeTriD package, demonstrating how it presents 3D models along with multiple genomic signals mapped onto single-cell 3D structures.
...
labelHighExpGene <- function(sig){
  ...
  l.rle$values[l.rle$lengths<=3] <- TRUE ## merge the region with small gap
