...
sdm_80 <- function(x){
  ...
  sdm_scaled_safe <- 1-sdm_scaled_safe
}
...
(RMSD_FLAMINGO <- sqrt(mean((mat_scaled_safe - sdm_80_FLAMINGO)^2, na.rm=TRUE)))
(RMSD_superRec <- sqrt(mean((mat_scaled_safe - sdm_80_superRec)^2, na.rm=TRUE)))
